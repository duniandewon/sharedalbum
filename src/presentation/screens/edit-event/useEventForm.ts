...
export type EventFormAction =
  | {
      type: "SET_FIELD";
      field: keyof Omit<EventFormState, "modals" | "isSubmitting" | "error">;
      value: any;
    }
...
export function useEventForm(
  ...
  const setField = <
    K extends keyof Omit<EventFormState, "modals" | "isSubmitting" | "error">
  >(
    field: K,
  ...
  const onCreateEvent = async () => {
    ...
    const { eventStartDate, eventEndDate } = formState;
